            ...
            <ul className="flex gap-x-2">
                {isAuthenticated ? (
                    <>
                        ...
                        <li>
                            <Link to='/login' onClick={() => {logout()}} className="bg-red-700 px-4 py-1 rounded-sm">Logout</Link>
                        </li>
                    </>
                ) : (
                    <>
                        ...
                        <li>
                            <Link to='/register' className="bg-green-800 px-4 py-1 rounded-sm">Register</Link>
                        </li>
                    </>
                )}
            </ul>
